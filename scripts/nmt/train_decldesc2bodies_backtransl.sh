...
$NEMATUS/nematus/nmt.py \
  --model data_ps.decldesc2bodies_backtransl.model.npz \
  --datasets data_ps.decldesc2bodies.train.bpe.backtransl.clean.dd data_ps.decldesc2bodies.train.bpe.backtransl.clean.bo \
  ...
  --domain_interpolation_indomain_datasets data_ps.decldesc2bodies.train.bpe.clean.dd data_ps.decldesc2bodies.train.bpe.clean.bo \
  --reload
