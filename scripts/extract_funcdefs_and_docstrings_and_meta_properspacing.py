...
def process_function(node, out_decl_fd, out_desc_fd, out_body_fd, out_meta_fd, input_filename):
...
def process_module(in_fd, out_decl_fd, out_desc_fd, out_body_fd, out_meta_fd, input_filename):
    ...
    for node in module_ast.body:
        if isinstance(node, ast.FunctionDef):
            process_function(node, out_decl_fd, out_desc_fd, out_body_fd, out_meta_fd, input_filename)
